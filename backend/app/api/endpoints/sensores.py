...
from app.schemas.sensores import FuenteDatosDispositivoCreate, FuenteDatosDispositivo, RegistroSensoresCreate, RegistroSensores
...
async def get_registros_by_fuente(
    id_fuente: int, 
    limit: Optional[int] = Query(1000, description="Número máximo de registros a retornar")
):
