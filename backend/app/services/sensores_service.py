    ...
    async def create_registro(self, registro: RegistroSensoresCreate) -> RegistroSensores:
        ...
        async with database.get_connection() as conn:
            ...
            INSERT INTO registro_sensores (
                ...
                gyro_magnitude, gps_lat, gps_lng, gps_accuracy, gps_speed,
                gps_speed_accuracy, gps_altitude, gps_altitude_accuracy, gps_heading,
                gps_heading_accuracy, gps_timestamp, gps_provider, device_orientation,
                sample_rate, gps_changed, id_fuente
