...
const RoadQualityMap: React.FC<RoadQualityMapProps> = ({ 
  ...
  // Función para cargar datos reales del JSON
  const loadRoadData = async () => {
    try {
      ...
      const data: RoadSegment[] = response.default;
      
      console.log(`Cargados ${data.length} segmentos de carreteras`);
      
      // Calcular estadísticas de segmentos
      const iqrValues = data.map(road => road.IQR);
